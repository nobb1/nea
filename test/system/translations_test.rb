...
class TranslationsTest < ApplicationSystemTestCase
  ...
  test "should create translation" do
    ...
    fill_in "Conjugation", with: @translation.conjugation
    fill_in "Example", with: @translation.example
    fill_in "Translation", with: @translation.translation
    fill_in "Type", with: @translation.type
    fill_in "Votes", with: @translation.votes
    fill_in "Word", with: @translation.word
